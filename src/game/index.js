...
export { updateProduction, updateSymbolProduction, updateLineProduction, processOfflineWithBreakdown, getLettersPerSecond, isGeneratorAutomated, isPurchaseLocked, getProducerName } from './production';
